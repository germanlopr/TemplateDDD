...
REM Eliminar Class1.cs del proyecto Domain
if exist "%projectName%.Domain\Class1.cs" (
    del "%projectName%.Domain\Class1.cs"
)
...
echo using %projectName%.Domain.Aggregates;
echo.
echo namespace %projectName%.Application.Mappings;
echo.
echo /// ^<summary^>
echo /// Mapeadores estáticos para convertir entidades del dominio a DTOs
echo /// ^</summary^>
echo public static class DomainToDtoMapper
echo {
echo     public static ProductResponse MapToProductResponse^(Product product^)
echo     {
echo         if ^(product == null^) throw new ArgumentNullException^(nameof^(product^)^);
echo.
echo         return new ProductResponse
echo         {
echo             Id = product.Id.Value,
echo             Name = product.Name,
echo             Price = product.Price.Amount,
...
echo     }
echo.
echo     public static CustomerResponse MapToCustomerResponse^(Customer customer^)
echo     {
echo         if ^(customer == null^) throw new ArgumentNullException^(nameof^(customer^)^);
echo.
echo         return new CustomerResponse
echo         {
echo             Id = customer.Id.Value,
echo             FirstName = customer.FirstName,
echo             LastName = customer.LastName,
...
echo     }
echo.
echo     public static OrderResponse MapToOrderResponse^(Order order^)
echo     {
echo         if ^(order == null^) throw new ArgumentNullException^(nameof^(order^)^);
echo.
echo         return new OrderResponse
echo         {
echo             Id = order.Id.Value,
...
echo             Status = order.Status.ToString^(^),
echo             OrderDate = order.OrderDate,
echo             TotalAmount = order.TotalAmount.Amount,
echo             Currency = order.TotalAmount.Currency,
echo             ItemCount = order.GetItemCount^(^),
echo             CreatedAt = order.CreatedAt,
echo             UpdatedAt = order.UpdatedAt
echo         };
echo     }
echo.
echo     public static IEnumerable^<ProductResponse^> MapToProductResponses^(IEnumerable^<Product^> products^)
echo     {
echo         return products?.Select^(MapToProductResponse^) ?? Enumerable.Empty^<ProductResponse^>^(^);
echo     }
echo.
echo     public static IEnumerable^<CustomerResponse^> MapToCustomerResponses^(IEnumerable^<Customer^> customers^)
echo     {
echo         return customers?.Select^(MapToCustomerResponse^) ?? Enumerable.Empty^<CustomerResponse^>^(^);
echo     }
echo.
echo     public static IEnumerable^<OrderResponse^> MapToOrderResponses^(IEnumerable^<Order^> orders^)
echo     {
echo         return orders?.Select^(MapToOrderResponse^) ?? Enumerable.Empty^<OrderResponse^>^(^);
echo     }
echo }
) > "%projectName%.Application\Mappings\DomainToDtoMapper.cs"

echo.
echo [OK] Mappings creados
echo.
REM ========== CLEANUP ==========
echo.
echo [INFO] Limpiando archivos autogenerados...

REM Eliminar Class1.cs del proyecto Application
if exist "%projectName%.Application\Class1.cs" (
    del "%projectName%.Application\Class1.cs"
    echo [OK] Class1.cs eliminado de Application
)
...
echo.
echo [SUCCESS] DependencyInjection.cs creado en Application
echo.
REM ========== CLEANUP INFRASTRUCTURE ==========
echo.
echo [INFO] Limpiando archivos autogenerados de Infrastructure...

REM Eliminar Class1.cs del proyecto Infrastructure
if exist "%projectName%.Infrastructure\Class1.cs" (
    del "%projectName%.Infrastructure\Class1.cs"
    echo [OK] Class1.cs eliminado de Infrastructure
)
...
echo.
echo.
echo [INFO] Creando Filters...

REM ========== FILTERS ==========

(
echo using Microsoft.AspNetCore.Mvc;
echo using Microsoft.AspNetCore.Mvc.Filters;
echo.
echo namespace %projectName%.%uiProject%.Filters;
echo.
echo /// ^<summary^>
echo /// Filtro para validación automática del ModelState
echo /// ^</summary^>
echo public class ValidateModelStateAttribute : ActionFilterAttribute
echo {
echo     public override void OnActionExecuting^(ActionExecutingContext context^)
echo     {
echo         if ^(!context.ModelState.IsValid^)
echo         {
echo             context.Result = new BadRequestObjectResult^(context.ModelState^);
echo         }
echo     }
echo }
) > "%projectName%.%uiProject%\Filters\ValidateModelStateAttribute.cs"
...
echo.
echo /// ^<summary^>
echo /// Filtro para logging de acciones del controlador
echo /// ^</summary^>
echo public class LoggingActionFilter : IActionFilter
echo {
echo     private readonly ILogger^<LoggingActionFilter^> _logger;
echo.
echo     public LoggingActionFilter^(ILogger^<LoggingActionFilter^> logger^)
echo     {
echo         _logger = logger;
echo     }
echo.
echo     public void OnActionExecuting^(ActionExecutingContext context^)
echo     {
echo         _logger.LogInformation^(
echo             "Executing action: {ActionName} on controller: {ControllerName}",
echo             context.ActionDescriptor.DisplayName,
echo             context.Controller.GetType^(^).Name^);
echo     }
echo.
echo     public void OnActionExecuted^(ActionExecutedContext context^)
echo     {
echo         _logger.LogInformation^(
echo             "Executed action: {ActionName} with status code: {StatusCode}",
echo             context.ActionDescriptor.DisplayName,
echo             context.HttpContext.Response.StatusCode^);
echo     }
echo }
) > "%projectName%.%uiProject%\Filters\LoggingActionFilter.cs"

echo.
echo [OK] Filters creados
echo.
...
echo.
echo.
echo [INFO] Creando archivo .http para testing de API...

REM ========== HTTP TESTING FILE ==========

(
echo ### %projectName% API - HTTP Testing File
echo ### Usa esta archivo con extensiones como REST Client para VS Code
echo.
...
echo GET {{baseUrl}}/api/products
echo.
echo ###
echo.
echo ### Get product by ID
echo GET {{baseUrl}}/api/products/1
echo.
echo ###
echo.
echo ### Get active products
echo GET {{baseUrl}}/api/products/active
echo.
echo ###
echo.
echo ### Get products in stock
echo GET {{baseUrl}}/api/products/in-stock
echo.
echo ###
echo.
echo ### Get products by price range
echo GET {{baseUrl}}/api/products/price-range?minPrice=10^&maxPrice=100
echo.
echo ###
echo.
echo ### Create new product
echo POST {{baseUrl}}/api/products
...
echo PUT {{baseUrl}}/api/products/1/price
echo Content-Type: {{contentType}}
echo.
echo {
echo   "newPrice": 149.99
echo }
echo.
echo ###
echo.
echo ### Add stock to product
echo POST {{baseUrl}}/api/products/1/stock/add
echo Content-Type: {{contentType}}
echo.
echo {
echo   "quantity": 5
...
echo ###
echo.
echo ### Remove stock from product
echo POST {{baseUrl}}/api/products/1/stock/remove
echo Content-Type: {{contentType}}
echo.
echo {
echo   "quantity": 3
...
echo POST {{baseUrl}}/api/products/1/deactivate
echo.
echo ###
echo.
echo ### Activate product
echo POST {{baseUrl}}/api/products/1/activate
echo.
echo ###
echo.
echo ### =================================
...
echo GET {{baseUrl}}/api/customers
echo.
echo ###
echo.
echo ### Get customer by ID
echo GET {{baseUrl}}/api/customers/1
echo.
echo ###
echo.
echo ### Get active customers
echo GET {{baseUrl}}/api/customers/active
echo.
echo ###
echo.
echo ### Create new customer
echo POST {{baseUrl}}/api/customers
echo Content-Type: {{contentType}}
echo.
echo {
echo   "firstName": "John",
...
echo ###
echo.
echo ### Update customer email
echo PUT {{baseUrl}}/api/customers/1/email
echo Content-Type: {{contentType}}
echo.
echo {
echo   "newEmail": "john.newemail@example.com"
echo }
echo.
echo ###
echo.
echo ### Deactivate customer
echo POST {{baseUrl}}/api/customers/1/deactivate
echo.
echo ###
echo.
echo ### =================================
...
echo.
echo ### Get all orders
echo GET {{baseUrl}}/api/orders
echo.
echo ###
echo.
echo ### Get order by ID
echo GET {{baseUrl}}/api/orders/1
echo.
echo ###
echo.
echo ### Get orders by customer
echo GET {{baseUrl}}/api/orders/customer/1
echo.
echo ###
echo.
echo ### Get pending orders
echo GET {{baseUrl}}/api/orders/pending
echo.
echo ###
echo.
echo ### Create new order
echo POST {{baseUrl}}/api/orders
echo Content-Type: {{contentType}}
echo.
echo {
echo   "customerId": 1
...
echo POST {{baseUrl}}/api/orders/1/items
echo Content-Type: {{contentType}}
echo.
echo {
echo   "productId": 1,
...
echo.
echo ### Confirm order
echo POST {{baseUrl}}/api/orders/1/confirm
echo.
echo ###
echo.
echo ### Ship order
echo POST {{baseUrl}}/api/orders/1/ship
echo.
echo ###
echo.
echo ### Deliver order
echo POST {{baseUrl}}/api/orders/1/deliver
echo.
echo ###
echo.
echo ### Cancel order
echo POST {{baseUrl}}/api/orders/1/cancel
echo.
echo ###
) > "%projectName%.%uiProject%\%projectName%.%uiProject%.http"

echo.
echo [OK] Archivo .http creado
echo.
...
echo.
echo [INFO] Limpiando archivos de prueba autogenerados...

REM Eliminar UnitTest1.cs de los proyectos de tests
if exist "%projectDirectory%\tests\%projectName%.Domain.Tests\UnitTest1.cs" (
    del "%projectDirectory%\tests\%projectName%.Domain.Tests\UnitTest1.cs"
    echo [OK] UnitTest1.cs eliminado de Domain.Tests
)

if exist "%projectDirectory%\tests\%projectName%.Application.Tests\UnitTest1.cs" (
    del "%projectDirectory%\tests\%projectName%.Application.Tests\UnitTest1.cs"
    echo [OK] UnitTest1.cs eliminado de Application.Tests
)

if exist "%projectDirectory%\tests\%projectName%.Infrastructure.Tests\UnitTest1.cs" (
    del "%projectDirectory%\tests\%projectName%.Infrastructure.Tests\UnitTest1.cs"
    echo [OK] UnitTest1.cs eliminado de Infrastructure.Tests
)
